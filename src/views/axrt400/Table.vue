  ...
  <div class="tableBox">
    ...
    <div class="countBox">
      <div class="line0">
        ...
        <div class="row2">本币：</div>
      </div>
      <div class="line1">
        <div class="row1">借方金额合计</div>
        <div class="row2">借方金额合计</div>
      </div>
      <div class="line2">
        <div class="row1">
          <el-input
      ...
      <div class="line3">
        <div class="row1">贷方金额合计</div>
        <div class="row2">贷方金额合计</div>
      </div>
      <div class="line4">
        <div class="row1">
          <el-input
      ...
      <div class="line5">
        <div class="row1">差异</div>
        <div class="row2">差异</div>
      </div>
      <div class="line6">
        <div class="row1">
          <el-input
