          ...
          <div class="forms">
            ...
            <ul class="left">
              <li>
                ...
                <div class="elInput msgBox" v-else>{{ serialNumber }}</div>
              </li>
              <li>
                <label class="label"
                  ><span
              ...
              <li>
                ...
                <div class="elInput msgBox" v-else>{{ applicant }}</div> -->
            ...
            <ul class="center">
              ...
              <li>
                ...
                <div class="elInput msgBox" v-else>{{ coinType }}</div>
              </li>
            </ul>
            <!-- right -->
            <ul class="right">
              <li>
                <ul>
                  <li>
                    ...
                    <div class="shortInput msgBox" v-else>{{ subject }}</div>
                  </li>
                  <li>
                    <label class="label" style="width: 100px"
                      >集团代收单号</label
                    ...
                    <el-input
                      ...
                      v-if="displayType == 'edit'"
                    ></el-input>
                    <div class="shortInput msgBox" v-else>{{ groupNum }}</div>
                  </li>
                </ul>
                <div class="img"></div>
              </li>
              <li>
                ...
                <el-input
                  ...
                  v-if="displayType == 'edit'"
                ></el-input>
                <div class="elInput msgBox" v-else>{{ audit }}</div>
              </li>
              <li>
                ...
                <el-input
                  ...
                  v-if="displayType == 'edit'"
                ></el-input>
                <div class="elInput msgBox" v-else>{{ statusNum }}</div>
              </li>
              <li>
                <div class="checkBox">
