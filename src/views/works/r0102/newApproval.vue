          ...
          <div class="tabContent">
            ...
            <div class="tableBox">
              ...
              <div class="form_line">
                ...
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa12') ? 'redPot' : ''">本次支付金额</span>
                </div>
              ...
              <div class="form_line">
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa15') ? 'redPot' : ''">税别</span>
                </div>
                ...
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa15') ? 'redPot' : ''">税率</span>
                </div>
...
import { azisList, pmasList, contracsInfo, } from "@/api/basic";
