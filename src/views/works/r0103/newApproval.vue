        ...
        <el-tab-pane name="firTab">
          ...
          <div class="tabContent">
            ...
            <div class="tableBox">
              ...
              <div class="form_line">
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10') ? 'redPot' : ''">付款申请单</span>
                </div>
                <div class="infobox longbox selectbox" v-if="!table_able.includes('oaa10')">
                  <div
                    class=""
              ...
              <div class="form_line">
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10_oaa01') ? 'redPot' : ''">付款编号</span>
                </div>
                <div class="infobox disabledbox editNot">
                  {{ tableData.oaa10_oaa01 }}
                </div>
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10_oaa11') ? 'redPot' : ''">预付厂商</span>
                </div>
                <div class="infobox disabledbox editNot">
                  {{ tableData.oaa10_oaa11 }}
                </div>
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10_oaa11') ? 'redPot' : ''">厂商简称</span>
                </div>
              ...
              <div class="form_line">
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10_oaa13') ? 'redPot' : ''">币种</span>
                </div>
                <div class="infobox disabledbox selectbox editNot">
                  {{ tableData.oaa10_oaa13_show }}
                </div>
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10_oaa14') ? 'redPot' : ''">汇率</span>
                </div>
                <div class="infobox disabledbox selectbox editNot">
                  {{ tableData.oaa10_oaa14 }}
                </div>
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa10_oaa17') ? 'redPot' : ''">发票金额</span>
                </div>
              ...
              <div class="form_line">
                ...
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa09') ? 'redPot' : ''">本次支付金额</span>
                </div>
                <div class="infobox selectbox last_row editNot" v-if="!table_able.includes('oaa09')">{{tableData.oaa09}}</div>
                <div class="infobox selectbox last_row" v-if="table_able.includes('oaa09')">
                  <input
                    class="abstracInput"
              ...
              <div class="form_line">
                ...
                <div class="infobox last_row longbox" style="width: 100%" v-if="!table_able.includes('oaa18')">
                  {{ tableData.oaa18 }}
                </div>
                <div class="infobox areabox last_row longbox" style="width: 100%" v-if="table_able.includes('oaa18')">
                  <el-input
                    type="textarea"
                    :rows="4"
              ...
              <div class="form_line last_line">
                ...
                <div class="infobox last_row longbox" style="width: 100%" v-if="!table_able.includes('oaa99')">
                  {{ tableData.oaa99 }}
                </div>
                <div class="infobox areabox last_row longbox" style="width: 100%" v-if="table_able.includes('oaa99')">
                  <el-input
                    type="textarea"
                    :rows="4"
              ...
              <div class="form_line">
                <div class="titlebox">
                  <span :class="form_must_able.includes('oaa16') ? 'redPot' : ''">收款方式</span>
                </div>
                <div class="infobox selectbox" :class="table_able.includes('oaa16')? '' : 'disabledbox'">
                  <el-select
                    v-model="tableData.oaa16"
                    class="select"
                    placeholder="请选择收款方式"
                    :disabled="table_able.includes('oaa16') ? false : true"
                  >
                    <el-option
              ...
              <div class="form_line">
                ...
                <div class="infobox middlebox selectbox last_row editNot" v-if="!table_able.includes('oaa24')">
                  {{tableData.oaa24}}
                </div>
                <div class="infobox middlebox selectbox last_row" v-if="table_able.includes('oaa24')">
                  <input
                    class="abstracInput"
              ...
              <!-- 冲销信息不可编辑 -->
              <div class="title_line" v-if="!table_able.includes('oae')">
                冲销信息
              </div>
              <div v-if="!table_able.includes('oae')">
                <el-table
                  :data="tableData.oae"
                  v-loading="false"
                  element-loading-background="rgba(0, 0, 0, 0.5)"
    ...
    selectDialog(type, rowIndex) {
      ...
      switch (type) {
        ...
        case "SQR":
          ...
          break;
        case "YHBH":
          let filter_YHBH = [{ label: "", model_key_search: "keyword" }];
          this.dataSelect.filter = filter_YHBH;
          this.dataSelect.searchType = "single";
          this.dataSelect.editType = "entry";
        ...
        case "bank":
          ...
          break;
        case "YDM_CW":
          let filter_YDM_CW = [{ label: "", model_key_search: "keyword" }];
          this.dataSelect.filter = filter_YDM_CW;
          this.dataSelect.searchApi = "meta/nmcs";
          this.dataSelect.searchType = "single"
          this.dataSelect.editType = "entry"
          this.dataSelect.headList = this.tableHead.head_YDM_CW;
          this.dataSelect.dialogTitle = "异动码";
          break;
        case "ZKLX":
