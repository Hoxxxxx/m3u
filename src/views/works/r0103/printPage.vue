      ...
      <div class="tabContent" id="tabContent">
        ...
        <div class="tableBox">
          ...
          <div class="form_line">
            ...
            <div class="infobox ">{{tableData.oaa10_oaa01}}</div>
            <div class="titlebox">预付厂商</div>
            <div class="infobox">{{tableData.oaa10_oaa11}}</div>
            <div class="titlebox">厂商简称</div>
            <div class="infobox last_row">{{tableData.oaa10_oaa11_show}}</div>
          </div>
          <!-- 2 -->
          <div class="form_line">
            <div class="titlebox">币种</div>
            <div class="infobox">{{tableData.oaa10_oaa13_show}}</div>
            <div class="titlebox">汇率</div>
            <div class="infobox selectbox">{{tableData.oaa10_oaa14}}</div>
            <div class="titlebox">发票金额</div>
            <div class="infobox last_row">{{tableData.oaa10_oaa17}}</div>
          </div>
          <!-- 3 -->
          <div class="form_line">
            <div class="titlebox">折合汇率金额</div>
            <div class="infobox">{{oaa10_ZHHLJE}}</div>
            <div class="titlebox">折合汇率金额大写</div>
            <div class="infobox ">{{oaa10_ZHHLJEDX}}</div>
            <div class="titlebox">本次支付金额</div>
            <div class="infobox last_row">{{tableData.oaa09}}</div>
          </div>
          <!-- 4 -->
          <div class="form_line">
          ...
          <div class="form_line">
            ...
            <div class="infobox selectbox ">{{tableData.oaa16_show}}</div>
          ...
          <!-- 拆分成几组表格 -->
          <div class="inner_Table" v-for="(F_item, F_index) in tableBox_oae" :key="'oae'+F_index">
            <!-- 有几个表头 -->
            <div class="tDataBox" v-for="(S_item, S_index) in F_item.theadList" :key="S_item+S_index">
              <div class="thead">{{S_item.label}}</div>
              <!-- 有几组内容 -->
              <div class="tdata" v-if="tableData.oae.length == 0"></div>
              <div class="tdata" v-for="(content_item, content_index) in tableData.oae" :key="content_item+content_index">
                {{content_item[S_item.value]}}
              </div>
            </div>
          </div>
          ...
          <div v-if="oazShow == 1">
            ...
            <div class="form_line last_line">
              ...
              <div class="infobox middlebox  middlebox last_row">{{tableData.oaz03}}</div>
            </div>
          </div>
        </div>
      </div>
