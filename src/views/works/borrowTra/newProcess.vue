          ...
          <div class="tabContent">
            ...
            <div class="tableBox">
              ...
              <div class="form_line lastline">
                <div class="titlebox required"><span :class="form_must.includes('oaa04') ? 'redPot' : ''">申请人</span></div>
                <div class="infobox selectbox">
                  <div class="selector" @click="selectDialog('SQR')">
                    {{ showData.oaa04_show }}
                  </div>
                </div>
                <div class="titlebox required"><span :class="form_must.includes('oaa04') ? 'redPot' : ''">员工编号</span></div>
              ...
              <div class="form_line">
                <div class="titlebox">
                  <span :class="form_must.includes('oaa35') ? 'redPot' : ''">出差地点</span>
                </div>
                <div class="infobox longbox selectbox">
              ...
              <div class="form_line">
                ...
                <div class="titlebox">
                  <span :class="form_must.includes('oaa23') ? 'redPot' : ''">对方单位</span>
                </div>
                <div class="infobox middlebox selectbox">
                  <input
                    class="abstracInput"
