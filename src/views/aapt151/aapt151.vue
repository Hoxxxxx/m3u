        ...
        <el-tab-pane label="借款资料" name="0">
          ...
          <div class="forms">
            ...
            <ul class="right">
              ...
              <li>
                <label class="label shortLabel"> 冲账 - </label>
                <div class="shortBoxs">
                  <div>
                    <el-input
...
export default {
  ...
  data() {
    return {
      ...
      paymentType: "", //支付类型
      borrow_money_local: "", //借款原币
      borrow_money_cur: "", //借款本币
      strike_money_local: "", //冲账原币
      strike_money_cur: "", //冲账本币
